...
const SocialAdsPackages = () => {
    const packages = content.services.socialAds.packages.items;
                ...
                <div className="max-w-[1440px] mx-auto">
                    ...
                    >
                        <p className="text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto tracking-tight">
                            {content.services.socialAds.packages.pricingNote}
                        </p>
                    </motion.div>
                </div>
            </div>
...
export default SocialAdsPackages;
