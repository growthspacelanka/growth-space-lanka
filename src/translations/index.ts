...
export const translations = {
    en: {
        ...
        'nav.webDev': 'Business Websites',
        'nav.ai': 'Online Stores',


        'hero.title.start': 'Affordable Websites ',
        'hero.title.highlight1': 'For Sri Lankan',
        'hero.title.middle': ' Businesses',
        'hero.title.highlight2': 'Made Simple',
        'hero.subtitle': 'Get your business online without confusion. Clear packages. Transparent pricing. Fast delivery.',
        'hero.cta.primary': 'View Website Packages',
        'hero.cta.secondary': 'How It Works',

        'services.title': 'What We Offer',
        'services.subtitle': 'Simple website solutions',
        'services.description': 'We build professional websites that help Sri Lankan businesses get customers online. No technical jargon. No hidden costs. Just clear, affordable packages.',
        'services.webdev.title': 'Business Websites',
        'services.webdev.description': 'Professional websites for shops, services, and small businesses. Mobile-friendly and easy to update.',
        'services.ai.title': 'E-commerce Websites',
        'services.ai.description': 'Online stores to sell your products. Secure payments. Easy product management.',
        ...
        'about.subtitle': 'Why we exist',
        'about.description': 'We started Growth Space Lanka because getting online shouldn\'t be confusing or expensive. We help Sri Lankan businesses get professional websites with clear pricing and honest service.',
        'about.cta': 'Start Your Website',

        'testimonials.title': 'What Our Clients Say',
        'testimonials.subtitle': 'Real businesses, real results',
        'testimonials.description': 'Sri Lankan businesses trust us to get them online. Here\'s what they say.',

        'testimonials.1.author': 'Kamal Perera',
        'testimonials.1.role': 'Shop Owner',
        'testimonials.1.company': 'Perera Hardware Store',
        'testimonials.1.content': 'I was worried about hidden costs, but everything was clear from the start. My website was ready in 2 weeks and customers can now find us online.',

        'testimonials.2.author': 'Sanduni Fernando',
        'testimonials.2.role': 'Owner',
        'testimonials.2.company': 'Fernando Beauty Salon',
        'testimonials.2.content': 'Simple process. Fair price. They explained everything in plain language. Now I can update my services myself.',

        'testimonials.3.author': 'Nimal Silva',
        'testimonials.3.role': 'Director',
        'testimonials.3.company': 'Silva Trading Company',
        'testimonials.3.content': 'Fast delivery and good support. The website works well on phones, which is important for our customers.',

        'testimonials.4.author': 'Priya Wickramasinghe',
        'testimonials.4.role': 'Manager',
        'testimonials.4.company': 'Wickramasinghe Catering',
        'testimonials.4.content': 'We got our online store set up quickly. Customers can order online now. No confusion, just clear service.',

        'testimonials.5.author': 'Rohan Jayasuriya',
        'testimonials.5.role': 'Owner',
        'testimonials.5.company': 'Jayasuriya Auto Repair',
        'testimonials.5.content': 'Affordable price and professional website. They helped us understand everything. Good value for money.',

        'process.title': 'How It Works',
        'process.subtitle': 'Simple steps to get online',
        'process.description': 'Getting your business online shouldn\'t be complicated. Here\'s how we make it easy.',
        'process.step1.title': 'Choose Your Package',
        'process.step1.description': 'Pick a package that fits your business. Clear pricing. No surprises.',
        'process.step2.title': 'Share Your Details',
        'process.step2.description': 'Tell us about your business. We\'ll handle the rest.',
        'process.step3.title': 'We Design & Build',
        'process.step3.description': 'We create your website. You review and give feedback.',
        'process.step4.title': 'Launch & Support',
        'process.step4.description': 'Your website goes live. We help you update it when needed.',
        'process.step5.title': '',
        'process.step5.description': '',
        'process.step6.title': '',
        'process.step6.description': '',

        'cta.title': 'Ready to Get Your Business Online?',
        'cta.description': 'Choose a package, share your details, and we\'ll build your website. No confusion. Clear pricing.',
        'cta.button': 'View Website Packages',

        'footer.description': 'Affordable website design for Sri Lankan businesses. Clear packages. Transparent pricing.',
        'footer.quickLinks': 'Quick Links',
        'footer.about': 'About Us',
        'footer.services': 'Services',
        'footer.contact': 'Contact',
        'footer.webDev': 'Business Websites',
        'footer.ai': 'Online Stores',
        ...
        'about.story.subtitle': 'Making websites simple',
        'about.story.description': 'We believe every Sri Lankan business deserves a professional website without the confusion.',
        'about.story.content1': 'Many business owners told us they wanted a website but were afraid of hidden costs, confusing tech terms, and long wait times. So we created Growth Space Lanka to solve that.',
        'about.story.content2': 'We offer clear packages, transparent pricing, and fast delivery. No upselling. No jargon. Just honest service that helps businesses get online.',

        'about.vision.title': 'Our Approach',
        'about.vision.subtitle': 'What we believe',
        'about.vision.statement': 'Getting online should be simple, affordable, and trustworthy. We focus on clarity, not confusion.',
        'about.mission.title': 'What We Do',
        'about.mission.statement': 'We build professional websites for Sri Lankan businesses with clear packages, fair pricing, and honest service.',

        'about.team.title': 'Our Team',
        'about.team.subtitle': 'People who understand your business',
        'about.team.description': 'We\'re a team that understands Sri Lankan businesses and what they need.',
        'about.team.member1.name': '',
        'about.team.member1.role': '',
        'about.team.member2.name': '',
        'about.team.member2.role': '',
        ...
        'services.page.description': 'Simple website solutions for your business',

        'services.webdev.subtitle': 'Business websites',
        'services.webdev.detailed': 'Professional websites that help customers find your business online. Works on phones, tablets, and computers.',
        'services.webdev.feature1': 'Mobile-friendly design that works on all devices',
        'services.webdev.feature2': 'Easy to update yourself or we can help',
        'services.webdev.feature3': 'Fast loading and easy to find on Google',
        'services.webdev.feature4': 'Secure and reliable hosting included',

        'services.ai.subtitle': 'Online stores',
        'services.ai.detailed': 'Sell your products online with a secure e-commerce website. Easy product management and payment processing.',
        'services.ai.feature1': 'Secure online payments',
        'services.ai.feature2': 'Easy product and inventory management',
        'services.ai.feature3': 'Order tracking for customers',
        'services.ai.feature4': 'Works with your existing business',

        'services.webdev.page.title': 'Business Websites',
        'services.webdev.page.description': 'Professional websites for Sri Lankan businesses',

        'services.webdev.features.title': 'What You Get',
        'services.webdev.features.subtitle': 'Everything included',
        'services.webdev.features.description': 'Professional websites with everything you need to get online',
        'services.webdev.features.custom.title': 'Business Websites',
        'services.webdev.features.custom.description': 'Showcase your business, services, and contact information. Perfect for shops, salons, and service providers.',
        'services.webdev.features.application.title': 'Landing Pages',
        'services.webdev.features.application.description': 'Single-page websites to promote special offers or events. Fast and affordable.',
        'services.webdev.features.ecommerce.title': 'Online Stores',
        'services.webdev.features.ecommerce.description': 'Sell products online with secure payments and easy product management.',
        'services.webdev.features.cms.title': 'Website Redesigns',
        'services.webdev.features.cms.description': 'Update your existing website with a fresh, modern design that works better.',
        ...
        'contact.page.description': 'Have questions? We\'re here to help',
        ...
        'contact.form.description': 'Tell us about your business and what you need. We\'ll respond quickly.',
        ...
        'contact.info.description': 'Reach us through any of these channels',
        ...
        'quote.form.title': 'Get Started',
        'quote.form.subtitle': 'Tell us about your business',
        'quote.form.description': 'Share your details and we\'ll recommend the best package for you. No obligation.',
        ...
        'quote.thankyou.title': 'Thank You!',
        'quote.thankyou.subtitle': 'We\'ve received your request',
        'quote.thankyou.description': 'We\'ll review your details and get back to you within 24 hours with package recommendations and pricing.',
